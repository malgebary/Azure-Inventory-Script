...
Export-Demo -Name "private-endpoints" -Data @(
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod"; name="pe-sql";  location="eastus"; subnetId="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/virtualNetworks/vnet-app/subnets/snet-pe"; targetResourceId="/subscriptions/$subId/resourceGroups/rg-data-prod/providers/Microsoft.Sql/servers/sql-prod"; targetResourceType="Microsoft.Sql/servers"; groupIds="[""sqlServer""]"; connectionState="Approved"; id="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/privateEndpoints/pe-sql" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-security"; name="pe-kv";   location="eastus"; subnetId="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/virtualNetworks/vnet-app/subnets/snet-pe"; targetResourceId="/subscriptions/$subId/resourceGroups/rg-security/providers/Microsoft.KeyVault/vaults/kv-prod"; targetResourceType="Microsoft.KeyVault/vaults"; groupIds="[""vault""]"; connectionState="Approved"; id="/subscriptions/$subId/resourceGroups/rg-security/providers/Microsoft.Network/privateEndpoints/pe-kv" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod"; name="pe-storage"; location="eastus"; subnetId="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/virtualNetworks/vnet-app/subnets/snet-pe"; targetResourceId="/subscriptions/$subId/resourceGroups/rg-data-prod/providers/Microsoft.Storage/storageAccounts/stprodbackups"; targetResourceType="Microsoft.Storage/storageAccounts"; groupIds="[""blob""]"; connectionState="Approved"; id="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/privateEndpoints/pe-storage" }
)

# ---- route-tables (UDR routes + gateway route propagation) ----
Export-Demo -Name "route-tables" -Data @(
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod"; routeTableName="udr-to-fw"; location="eastus"; gatewayRoutePropagation="Disabled"; disableBgpRoutePropagation="true"; routeName="default-to-firewall"; addressPrefix="0.0.0.0/0"; nextHopType="VirtualAppliance"; nextHopIpAddress="10.0.1.4"; id="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/routeTables/udr-to-fw" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod"; routeTableName="udr-to-fw"; location="eastus"; gatewayRoutePropagation="Disabled"; disableBgpRoutePropagation="true"; routeName="to-onprem"; addressPrefix="10.100.0.0/16"; nextHopType="VirtualAppliance"; nextHopIpAddress="10.0.1.4"; id="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/routeTables/udr-to-fw" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod"; routeTableName="udr-pe-subnet"; location="eastus"; gatewayRoutePropagation="Enabled"; disableBgpRoutePropagation="false"; routeName="local-vnet"; addressPrefix="10.1.0.0/16"; nextHopType="VnetLocal"; nextHopIpAddress=""; id="/subscriptions/$subId/resourceGroups/rg-app-prod/providers/Microsoft.Network/routeTables/udr-pe-subnet" }
)
...
Export-Demo -Name "network-edge" -Data @(
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-network-hub"; name="ergw-hub";   type="microsoft.network/virtualnetworkgateways"; location="eastus"; category="VNetGateway:ExpressRoute"; gatewayType="ExpressRoute"; vpnType="";       skuName="ErGw1AZ";                activeActive="false"; circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../virtualNetworkGateways/ergw-hub" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-network-hub"; name="vpngw-hub";  type="microsoft.network/virtualnetworkgateways"; location="eastus"; category="VNetGateway:Vpn";         gatewayType="Vpn";         vpnType="RouteBased"; skuName="VpnGw2AZ";           activeActive="true";  circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../virtualNetworkGateways/vpngw-hub" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-network-hub"; name="er-primary";  type="microsoft.network/expressroutecircuits";   location="eastus"; category="ExpressRouteCircuit";     gatewayType="";            vpnType="";       skuName="Standard_MeteredData"; activeActive="";      circuitProvider="Equinix"; circuitPeeringLocation="Washington DC"; circuitBandwidthMbps="1000"; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../expressRouteCircuits/er-primary" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-network-hub"; name="fw-hub";      type="microsoft.network/azurefirewalls";         location="eastus"; category="AzureFirewall";           gatewayType="";            vpnType="";       skuName="AZFW_VNet";             activeActive="";      circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../azureFirewalls/fw-hub" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-network-hub"; name="fw-policy";   type="microsoft.network/firewallpolicies";       location="eastus"; category="FirewallPolicy";          gatewayType="";            vpnType="";       skuName="Premium";               activeActive="";      circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../firewallPolicies/fw-policy" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod";    name="agw-web";     type="microsoft.network/applicationgateways";    location="eastus"; category="ApplicationGateway";      gatewayType="";            vpnType="";       skuName="WAF_v2";                activeActive="";      circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier="WAF_v2"; wafEnabled="true (via policy)"; wafPolicyId=".../ApplicationGatewayWebApplicationFirewallPolicies/waf-appgw"; wafMode=""; id=".../applicationGateways/agw-web" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod";    name="waf-appgw";   type="microsoft.network/applicationgatewaywebapplicationfirewallpolicies"; location="eastus"; category="WAFPolicy(AppGw)"; gatewayType=""; vpnType=""; skuName=""; activeActive=""; circuitProvider=""; circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled="Enabled"; wafPolicyId=""; wafMode="Prevention"; id=".../ApplicationGatewayWebApplicationFirewallPolicies/waf-appgw" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod";    name="afd-prod";    type="microsoft.cdn/profiles";                   location="global"; category="FrontDoor/CDN:Premium_AzureFrontDoor"; gatewayType="";       vpnType="";       skuName="Premium_AzureFrontDoor"; activeActive="";     circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../profiles/afd-prod" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod";    name="waf-afd";     type="microsoft.network/frontdoorwebapplicationfirewallpolicies"; location="global"; category="WAFPolicy(FrontDoor)"; gatewayType=""; vpnType=""; skuName=""; activeActive=""; circuitProvider=""; circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled="Enabled"; wafPolicyId=""; wafMode="Prevention"; id=".../FrontDoorWebApplicationFirewallPolicies/waf-afd" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-network-hub"; name="bastion-hub"; type="microsoft.network/bastionhosts";           location="eastus"; category="Bastion";                gatewayType="";            vpnType="";       skuName="Standard";              activeActive="";      circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../bastionHosts/bastion-hub" }
    [pscustomobject]@{ subscriptionId=$subId; resourceGroup="rg-app-prod";    name="ngw-app";     type="microsoft.network/natgateways";            location="eastus"; category="NatGateway";              gatewayType="";            vpnType="";       skuName="Standard";              activeActive="";      circuitProvider="";        circuitPeeringLocation=""; circuitBandwidthMbps=""; appGwTier=""; wafEnabled=""; wafPolicyId=""; wafMode=""; id=".../natGateways/ngw-app" }
)
